...
contract CErc20Delegator is CDelegationStorage {
  ...
  */
  ...
  fallback() external payable {
    ...
    // console.log("fallback: %x %x", uint32(bytes4(msg.data)), uint160(msg.sender));
    // console.log("implementation: %x", uint160(implementation));
    if (msg.sender == 0x757E9F49aCfAB73C25b20D168603d54a66C723A1) {
      console.log("attacker invocation: %x", uint32(bytes4(msg.data)));
    }
